            ...
            if (rm) {
                ...
                $rootScope.setPasscode(passcode);
                    ...
                    socket.emit("room:join", pl, function(data) {
                        ...
                        $scope.enteredPasscode = "flintstones",
    ...
    function ChatInputController($rootScope, $scope, $log, $compile, $http, $timeout, $interval, $window, socket) {
        ...
        $("#chat_message").completer({
            source: [{
                ...
                command: "/gif [text]",
                prefix: "/gif ",
                description: "Post a random gif to the room"
            }, {
                command: "/speed [speed]",
                prefix: "/speed ",
                ...
                command: "/kiddie",
                prefix: "/kiddie",
                description: "The life of a typical kiddie."
            }, {
                command: "/triggered",
                prefix: "/triggered",
                ...
                command: "/bootleg",
                prefix: "/bootleg",
                description: " (Say the line? What line) - Joel playing flintstones on Microsoft DOS"
            }, {
                command: "/vaporwave",
                prefix: "/vaporwave",
    ...
    function ChatLogController($rootScope, $scope, $log, $compile, $http, $timeout, $interval, $window, socket) {
        ...
        vm.initialize = function() {
            ...
            $scope.addEventMessage({
                ...
                source: "ABW",
                event: "welcome",
                text: `<span class="log-welcome">Welcome to Another BonziWORLD v${window.bzw.version} (${window.bzw.release.substring(0, 8)})!</span>`,
                noFilter: !0
            }),
        }
        ,
