/*!
  * Application : ABonziWORLD
  * Version     : INFINITE
  * Release     : 77gg7d77d7d777dggg7d17d7777d77777g77d7g7d
  * Website     : https://www.bonzi.world
  * Module      : AngularJS
  * Built       : 2021-08-12T18:16:48-0400
...
$(function () {
    ...
    (BZWAgents.prototype.getAgent = function (name) {
        if (name) { 
            return (
                ["black", "blue", "brown", "green", "purple", "seamus", "red", "pink", "pope", "orange", "yellow", "white"].includes(name.toLowerCase()) && (name = "Bonzi"),
    ...
    vargskelethor = new Agent("vargskelethor", {
        size: { x: 168, y: 142 },
...
var BonziData = {
    ...
    event_list_joke_open: [
        [
            ...
            { type: "text", text: '"Haha, look at the stupid {COLOR} Character telling jokes!" Fuck you. It isn\'t funny.', say: "Hah hah! Look at the stupid {COLOR} Character telling jokes! Fuck you. It isn't funny." },
    ...
    event_list_joke_mid: [
        ...
        [
            ...
            { type: "text", text: "Sorry. I just had an seizure." },
        ],
        [
            {
                type: "text",
        ...
        [
            { type: "text", text: "How do you call a retarded person who likes bootlegs?" },
            { type: "text", text: "A grand-tarted person." },
        ],
        [
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_kiddie = [
        ...
        },
        {
            type: "text",
            text:
                "I make BonziWORLD Reacts to CharacWORLD reacts to BonziWORLD Revived reacts to stuff. And also i use AVS Video Editor to make Klasky Csupo Effects videos! I use GoAnimate to ground innocent people who did nothing wrong to me. ",
        },
        { type: "text", text: "I beg people to boost My Discord server for no reason that has a lot of FNF, GoAnimate, BFDI and many more stuff in it!" },
        {
            type: "text",
            text:
...
var Bonzi = (function () {
    function Bonzi(id, userPublic) {
        ...
        _classCallCheck(this, Bonzi),
            (this.bounceColors = ["black", "blue", "brown", "green", "purple", "red", "ghost","clippy", "orange", "yellow", "peedy"]),
            (this.availableColours = ["black", "blue", "brown", "green", "purple", "red", "ghost", "clippy", "vargskelethor", "yellow", "orange", "links", "merlin", "peedy", "packetman", "gd", "robby", "rover"]),
            (this.overlayOffset = { left: 0, top: 0 }),
        ...
        (this.x = coords.x * this.rng()),
            ...
            setTimeout(function () {
                ...
                } else if (d.color === "vargskelethor") {
                } else if (d.color == "packetman") {
                } else if (d.color === "seamus") {
                if (d.color == "gd") {
                    d.color != "clippy" &&
                    d.color != "rover" &&
                    d.color != "seamus" &&
				...
				try {
					switch (list[0].toLowerCase()) {
						...
						case "pawn":
							...
							break;
						case "bootleg":
							window.dataLayer.push({ event: "bootleg_detected" });
							break;
						case "kiddie":
							window.dataLayer.push({ event: "bawwwwwwwwwww" });
							break;
						case "vaporwave":
...
(function () {
    ...
    window._jsModules.framework = { module: "Framework", version: "INFINITE", release: "777777777777777777777777777777777", built: "2021-08-12T18:16:46-0400", environment: "development" };
})();
